    ...
    if ($conn->connect_error) {
       ...
       if ($result->num_rows == 1) {
           echo "Email and password are correct";
            ...
            echo "Wrong email and password commbination";
    }
...
<html>
<head>
	<title>Tutorial using php</title>
</head>
<body>
	<form method ="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>">
		<input type="passowrd" name="password" placeholder="password" id="password" required ="required">
